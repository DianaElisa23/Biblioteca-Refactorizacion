 ...
 * Esta se encarga de controlar el sistema y las operaciones sobre los libros, usuarios y prestamos
 * Permitiendo regitrar libros y usuarios, realizar prestamos y devoluciones de libros, etc
 * Funciona con las demás clases (libro, usuario, prestamos)
 */
...
public class BibliotecaApp {
    ...
    private static void inicializarDatos() {
        // Libros de ejemplo
        libros.add(new Libro(1, "Don Quijote de la Mancha", "Miguel de Cervantes", 1605, "Ficción", "Fisico", true));
        libros.add(new Libro(2, "Cien años de soledad", "Gabriel García Márquez", 1967, "Novela", "audiolibro", true));
        libros.add(new Libro(3, "El principito", "Antoine de Saint-Exupéry", 1943, "Fábula", "fisico", true));
        
        // Usuarios de ejemplo
        usuarios.add(new Usuario(101, "Jose Camacho", "Profesor", "jantonio@gmail.com", "123456789"));
        usuarios.add(new Usuario(102, "Patricia Moreno", "Profesor", "patricia@gmail.com", "987654321"));
    }
    ...
    private static void registrarLibro() {
        ...
        System.out.print("Tipo: "); // fisico, digital, audiolibro
        ...
        switch (tipo) { 
            case "fisico":
                nuevoLibro = new TiposLibro.LibroFisico(id, titulo, autor, anio, genero, true);
                break;
            case "digital":
                nuevoLibro = new TiposLibro.LibroDigital(id, titulo, autor, anio, genero, true);
                break;
            case "audiolibro":
                nuevoLibro = new TiposLibro.Audiolibro(id, titulo, autor, anio, genero, true);
                break;
            default:
    ...
    private static void registrarUsuario() {
        ...
        System.out.print("Tipo de usuario: "); // Estudiante o Profesor
        String tipo = scanner.nextLine().toLowerCase();
        ...
        switch (tipo) {
            case "estudiante":
                nuevoUsuario = new TipoUsuario.Estudiante(id, nombre, email, telefono);
                break;
            case "profesor":
                nuevoUsuario = new TipoUsuario.Profesor(id, nombre, email, telefono);
                break;
            default:
                System.out.println("Tipo de usuario no válido. Registro cancelado.");
                return;
        }
        ...
        for (Libro libro : libros) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4: 
                    coincide = libro.getTipo().toLowerCase().contains(termino);
                    break;
                default:
                    System.out.println("Opción no válida.");
                    return;
    ...
    private static void mostrarUsuarios() {
        ...
        for (Usuario usuario : usuarios) {
            System.out.println("ID: " + usuario.getId() + " | Nombre: " + usuario.getNombre() + " | Tipo Usuario: " + usuario.getTipoUsuario() +
